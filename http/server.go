...
Функция Serve использует службу Configuration для считывания
параметров HTTP и HTTPS и использует функции, предоставляемые
стандартной библиотекой, для получения запросов и передачи их в конвейер для
обработки.
*/
